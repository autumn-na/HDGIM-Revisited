# Experiment 3: Distribution of 2-bit precision bound hypervector, using min-max
...
# draw plot
plt.hist(model.quantized_hypervector.numpy(), bins=30, density=True, alpha=0.7, color='blue', edgecolor='black')

plt.title('Distribution of 2-bit Precision Bound Hypervector')
plt.xlabel('Value')
plt.ylabel('Density')
